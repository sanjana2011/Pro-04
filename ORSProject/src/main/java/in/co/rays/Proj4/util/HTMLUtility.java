...
/**
 * Utility class to generate HTML `<select>` (dropdown) elements from collections.
 * <p>
 ...
 * </ul>
 * Automatically includes a default "Select" option and marks a given value as selected.
 * </p>
 * <p>This class provides only static methods and should not be instantiated.</p>
 * 
...
public class HTMLUtility {
     ...
     * @param selectedVal the key value to be marked as selected (can be null or empty)
     * @param map         a {@code HashMap<String,String>} where the key is option value and the value is display text
     ...
     * @param name        the HTML name attribute for the `<select>` tag
     * @param selectedVal the key value to be marked as selected (can be null or empty)
     * @param list        a {@code List} of {@link DropdownListBean}, each with {@code getKey()} and {@code getValue()}
     * @return a {@code String} containing the complete HTML `<select>` element
     */
	public static String getList(String name, String selectedVal, List list) {
	 ...
	 /**
     * A test method demonstrating generation of HTML from a simple map.
     * Prints the HTML dropdown to standard output.
     */
	public static void testGetListByMap() {
	  ...
	  /**
     * A test method demonstrating generation of HTML from a list of RoleBean objects.
     * Prints the HTML dropdown to standard output.
     *
